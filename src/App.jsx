...
function App() {
  ...
  return (
    <article className='pt-6'>
      <header className='flex flex-col gap-2 w-full px-4 z-50 underline'>input form
        <div className='relarive z-50'>
      ...
      <section className='pt-6 flex flex-col justify-content items-center overflow'>
      ...
      <div className ='text-center'>
        ...
        className= 'bg-slate-800 px-6 py-2 my-4 text-vase rounded-lg font-bold text-white'> 더보기 </button>
      </div>
    </article>
  )
}
